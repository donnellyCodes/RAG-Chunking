...
class AgenticChunker:
    ...
    def add_propositions(self, propositions):
        from proposition in propositions:
    ...
    def add_proposition(self, proposition):
        ...
        # if a chunk was found then add the proposition for it
        if chunk_id:
            if self.print_logging:
            ...
            # if a chunk wasn't fount, then create a new one
            self._create_new_chunk(proposition)
    ...
    def _update_chunk_summary(self, chunk):
        """
        if you add a new proposition to a chunk, you may not want to update the summary or else they could get stale
        """
        PROMPT = ChatPromptTemplate.from_messages(
            [
                (
                    "system",
                    """
                    You are steward with a group of chunks which represent groups of sentences that talk about a similar topic
                    ...
                    Your summarise should anticipate generalization. If you get a proposition about apples, generalize it to food.
                    or month, generalize it to "date" and "times".
                    
                    EXAMPLE:
                    Input: Proposition: Greg likes to eat Pizza
                    Output: This chunk contains information about the type of food greg likes to eat.
        ...
        new_chunk_summary = runnable.invoke({
            "proposition": "\n".join(chunk['proposition']),
            "current_summary" : chunk['summary']
        }).content
        
        return new_chunk_summary
    
    def update_chunk_title(self, chunk):
        """
        if you add a new proposition to a chunk, you may want to update the title or else it can be stale
        """
        PROMPT = ChatPromptTemplate.from_messages(
            [
                (
    ...
    def _create_new_chunk(self, proposition):
        ...
        if self.print_logging:
            print (f"Create new chunk ({new_chunk_id}): {new_chunk_title}")
                    ...
                    (
                        ...
                        Input:
                            ...
                            - Current Chunks:
                                ...
                                - Chunk Summary: Lists of food and dishes that Greg likes
                        Output: 93833k
                        """,
                    ),
                    ("user", "Current Chunks:\n--Start of current chunks--\n{current_chunk_outline}\n--End of current chunks--"),
                    ("user": "Determine if the following statement should belong to one of the chunks outline:\n{proposition}"),
                ]
            )
